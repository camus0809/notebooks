...
> [!important]
>
> <p style="color: red">一般情况下I2C的SDA只有在SCL为低电平的时候才能改变</p>
...
- OLED没有背光层
  ...
  - 优点
    ...
    - 不需要通电后整个背光层亮起，因此可以做**息屏提醒 Always on display**
    - 近乎无限的对比度
      - 画面黑白明暗的亮度比值 越高越鲜艳，色彩越浓郁
  ...
  - 缺点
    ...
    - 调光方式 只能使用低频PWM调光方式，低频对眼睛伤害高   （*因为是有机屏幕易老化也不能使用高频调光*）

    - 理论分辨率达不到理论清晰度

      - 清晰度的单位为PPI

        - PPI    300 够用 /360 清晰 /420 锐利

        ![image-20251124225424562](https://raw.githubusercontent.com/camus0809/Typora_Image/devw/Image_2025/1124/image-20251124225424562.png)


1. 主流显示面板:LCD、OLED、MicroLED
